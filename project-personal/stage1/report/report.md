...
author: "Тютрюмова Анжелина Артёмовна"
...
![Клонирование репозитория шаблона](image/2.jpg){ #fig:002 width=70% }

Инициализируем git репозиторий, делаем коммит, и связываем с новым репозиторием github (рис. [-@fig:003]).
 
![Связка репозитория с локальным](image/3.jpg){ #fig:003 width=70% }
